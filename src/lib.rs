            ...
            tasks.into_iter().enumerate().map(|(i, t)| {
                ...
                tr![
                    C![
                        ...
                        "cursor-pointer",
                        "select-none",
                        IF!(t.urgency.unwrap_or(0.) > 5.0 => "bg-yellow-200"),
                        IF!(t.urgency.unwrap_or(0.) > 5.0 => "hover:bg-yellow-400"),
                        IF!(t.urgency.unwrap_or(0.) > 10.0 => "bg-red-200"),
                        IF!(t.urgency.unwrap_or(0.) > 10.0 => "hover:bg-red-400"),

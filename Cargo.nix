    ...
    crates = {
      ...
      "automerge" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "52412ee75a3b1c027b8d21f247c779dc9f645976";
          sha256 = "0rcf9nryjlyxksp99bw2bynvhpimyfmvprx3ri0rkb7h740bc5zq";
        };
        authors = [
      ...
      "automerge-persistent" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "602079ab63637a261979f54dd047a06899df7fb8";
          sha256 = "088r87a91h2ccph6y03lhqvh5df87vg0jn3k0rz6nz71azgzd8yn";
        };
        authors = [
      ...
      "automerge-persistent-localstorage" = rec {
        crateName = "automerge-persistent-localstorage";
        version = "0.1.0";
        edition = "2018";
        workspace_member = null;
        src = pkgs.fetchgit {
      ...
      "automergeable" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "e548064052793e2124e440084b003ae580e2103a";
          sha256 = "13my4w4nvpndndsx4qjv0a6kwh2npq7q9fkkam5hwpjjyzp0yy04";
        };
        authors = [
          "Andrew Jeffery <dev@jeffas.io>"
        ];
      ...
      "clap" = rec {
        ...
        version = "3.0.0-rc.8";
        edition = "2018";
        sha256 = "0x1vph7zwp8fpbcfnhda00fhmfi0k3j20p57yjk9bdhpjj1ifks8";
        dependencies = [
          {
            name = "atty";
            packageId = "atty";
        ...
        resolvedDefaultFeatures = [ "atty" "clap_derive" "color" "default" "derive" "env" "lazy_static" "std" "strsim" "suggestions" "termcolor" ];
      };
      "clap_derive" = rec {
        crateName = "clap_derive";
        version = "3.0.0-rc.8";
        edition = "2018";
        sha256 = "1f1my7z4v5z5mfwdqvpq0ncj2q5ki4pnbpsf995dqkgrk73lwvd8";
        procMacro = true;
        dependencies = [
          {
            name = "heck";
      ...
      "enclose" = rec {
        ...
        version = "1.1.8";
        edition = "2018";
        sha256 = "0mwk686pzbzabb8s52k4lyiy0qifnm4glbk6b819qvj2v99zamhh";
        authors = [
      ...
      "gloo-events" = rec {
        ...
        version = "0.1.1";
        edition = "2018";
        sha256 = "0kw1pk2nb5w267p94iki6h0p6flvcdmsd21cfqf8k17jivn19188";
        authors = [
      ...
      "gloo-file" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0jggcnj2fdgb0b89c1w6jcn4ywfch2jqpsaqdz23rp5m8vzfr7wg";
        authors = [
          "Rust and WebAssembly Working Group"
        ];
        dependencies = [
      ...
      "hmac" = rec {
        ...
        version = "0.12.0";
        edition = "2018";
        sha256 = "18nnjkvvpkjw6ppcyijysgxmr4a7knd98msb6vgy4b3z7qgi7jnx";
        authors = [
          "RustCrypto Developers"
        ];
        dependencies = [
      ...
      "md-5" = rec {
        ...
        version = "0.10.0";
        edition = "2018";
        sha256 = "1bhn8b9135n4xdm20vfv401yf9l8z0b9b4c2hw2i1g4bbk2qz8z6";
        libName = "md5";
        authors = [
          "RustCrypto Developers"
        ];
      ...
      "postgres-protocol" = rec {
        ...
        version = "0.6.3";
        edition = "2018";
        sha256 = "04ypmsnx7sijzca8f7drd5nnhx6z5nxccr2cgjib860zwyy07v3r";
        authors = [
          "Steven Fackler <sfackler@gmail.com>"
        ];
        dependencies = [
      ...
      "postgres-types" = rec {
        ...
        version = "0.2.2";
        edition = "2018";
        sha256 = "03bbkl05xz00179bcg48k9rvq9dqgih76w7wyjchkj0cpaa9yq84";
        authors = [
          "Steven Fackler <sfackler@gmail.com>"
        ];
        dependencies = [
      ...
      "seed" = rec {
        ...
        version = "0.8.0";
        edition = "2018";
        sha256 = "0dj5mlynd02mps07w53cgfgq3m2ln6zqm6y9gx5nyiaprklrnn9v";
        authors = [
          "DavidOConnor <david.alan.oconnor@gmail.com>"
          "Martin Kavík <martin@kavik.cz>"
        ];
        dependencies = [
          {
          ...
          }
          {
            name = "web-sys";
            packageId = "web-sys";
            features = [ "AbortController" "AbortSignal" "BeforeUnloadEvent" "Blob" "BinaryType" "CanvasRenderingContext2d" "CloseEvent" "console" "CustomEvent" "CustomEventInit" "DataTransfer" "Document" "DomException" "DragEvent" "Element" "Event" "EventTarget" "File" "FormData" "HashChangeEvent" "Headers" "History" "HtmlElement" "HtmlCanvasElement" "HtmlCollection" "HtmlDocument" "HtmlInputElement" "HtmlMenuItemElement" "HtmlProgressElement" "HtmlOptionElement" "HtmlDataElement" "HtmlMeterElement" "HtmlLiElement" "HtmlOutputElement" "HtmlParamElement" "HtmlTextAreaElement" "HtmlSelectElement" "HtmlButtonElement" "Location" "MessageEvent" "MouseEvent" "Navigator" "Node" "NodeList" "Performance" "PointerEvent" "PopStateEvent" "ReferrerPolicy" "Request" "RequestCache" "RequestCredentials" "RequestInit" "RequestMode" "RequestRedirect" "Response" "Selection" "Storage" "TcpReadyState" "Text" "Touch" "TouchEvent" "TouchList" "console" "WebSocket" "Window" "KeyboardEvent" "InputEvent" "Url" "UrlSearchParams" ];
          }
        ];
        buildDependencies = [
          {
      ...
      "sha2 0.10.0" = rec {
        ...
        version = "0.10.0";
        edition = "2018";
        sha256 = "1dnw5dfp4bbsxjz2nkx5d54vgsig0x66jd9b5z7mpcbbsd6rc3ch";
        authors = [
          "RustCrypto Developers"
        ];
        dependencies = [
      ...
      "tasknet" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./tasknet-web; };type = [ "cdylib" ];
        authors = [
          "Andrew Jeffery <dev@jeffas.io>"
        ];
        dependencies = [
          ...
          {
            name = "automerge-persistent-localstorage";
            packageId = "automerge-persistent-localstorage";
          }
          {
            name = "automerge-protocol";
            packageId = "automerge-protocol";
          ...
          }
          {
            name = "web-sys";
            packageId = "web-sys";
            features = [ "Navigator" "Window" "ServiceWorkerContainer" ];
          }
        ];
        devDependencies = [
          {
      ...
      "tasknet-server" = rec {
        crateName = "tasknet-server";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "tasknet-server"; path = "src/main.rs"; }
        ];
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./tasknet-server; };
        authors = [
          "Andrew Jeffery <dev@jeffas.io>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "warp-reverse-proxy";
          }
        ];

      };
      "tasknet-sync" = rec {
        crateName = "tasknet-sync";
        version = "0.1.0";
        edition = "2018";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./tasknet-sync; };
        authors = [
          "Andrew Jeffery <dev@jeffas.io>"
        ];
        dependencies = [
      ...
      "tokio-postgres" = rec {
        ...
        version = "0.7.5";
        edition = "2018";
        sha256 = "15ff5s66k20i5q993lkycl2nridqxdyzi6wgrn6m86v6vwrqnv2b";
        authors = [
          "Steven Fackler <sfackler@gmail.com>"
        ];
        dependencies = [
      ...
      "warp-reverse-proxy" = rec {
        crateName = "warp-reverse-proxy";
        version = "0.4.0";
        edition = "2018";
        sha256 = "0qh5hh3sbw0kkiqln9ih0n1ig57bdmg79w7lq2dah79ksvr7m7kk";
        authors = [
          "danielsanchezq <daniel.sanchez@iohk.io>"
        ];
        dependencies = [
          {
            name = "hyper";
      ...
      "wasm-bindgen-test" = rec {
        ...
        version = "0.3.28";
        edition = "2018";
        sha256 = "0zkb3swn81blwg0kdl2y49paaxgavc122q2kygq1xxpxf5wsmwcn";
        authors = [
          "The wasm-bindgen Developers"
        ];
        dependencies = [
      ...
      "wasm-bindgen-test-macro" = rec {
        ...
        version = "0.3.28";
        edition = "2018";
        sha256 = "124ng2j16jf8lfdgq1lg83c7zka42fzizdaddnl9dsyz52bgf1k0";
        procMacro = true;
        authors = [
          "The wasm-bindgen Developers"
        ];
      ...
      "web-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "AbortController" "AbortSignal" "AddEventListenerOptions" "BeforeUnloadEvent" "BinaryType" "Blob" "BlobPropertyBag" "CanvasRenderingContext2d" "CharacterData" "CloseEvent" "Crypto" "CustomEvent" "CustomEventInit" "DataTransfer" "Document" "DomException" "DragEvent" "Element" "Event" "EventTarget" "File" "FileList" "FilePropertyBag" "FileReader" "FormData" "HashChangeEvent" "Headers" "History" "HtmlButtonElement" "HtmlCanvasElement" "HtmlCollection" "HtmlDataElement" "HtmlDocument" "HtmlElement" "HtmlInputElement" "HtmlLiElement" "HtmlMenuItemElement" "HtmlMeterElement" "HtmlOptionElement" "HtmlOutputElement" "HtmlParamElement" "HtmlProgressElement" "HtmlSelectElement" "HtmlTextAreaElement" "InputEvent" "KeyboardEvent" "Location" "MessageEvent" "MouseEvent" "Navigator" "Node" "NodeList" "Performance" "PointerEvent" "PopStateEvent" "ReferrerPolicy" "Request" "RequestCache" "RequestCredentials" "RequestInit" "RequestMode" "RequestRedirect" "Response" "Selection" "ServiceWorkerContainer" "ServiceWorkerGlobalScope" "Storage" "TcpReadyState" "Text" "Touch" "TouchEvent" "TouchList" "UiEvent" "Url" "UrlSearchParams" "WebSocket" "Window" "Worker" "WorkerGlobalScope" "console" ];
      };
      "webpki" = rec {
        crateName = "webpki";
        version = "0.21.4";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "cfg" "consoleapi" "errhandlingapi" "evntrace" "fileapi" "handleapi" "impl-debug" "impl-default" "in6addr" "inaddr" "ioapiset" "lmcons" "minschannel" "minwinbase" "minwindef" "mstcpip" "mswsock" "namedpipeapi" "ntdef" "ntsecapi" "ntstatus" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "synchapi" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "windef" "winerror" "winioctl" "winnt" "winreg" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
